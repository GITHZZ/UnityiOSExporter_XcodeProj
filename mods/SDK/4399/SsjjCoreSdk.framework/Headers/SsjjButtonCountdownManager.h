...
@class SsjjJMSDKCountdownTask;

@interface SsjjButtonCountdownManager : NSObject
 ...
 */
- (BOOL)countdownTaskExistWithKey:(NSString *)akey task:(SsjjJMSDKCountdownTask * _Nullable * _Nullable)task;
