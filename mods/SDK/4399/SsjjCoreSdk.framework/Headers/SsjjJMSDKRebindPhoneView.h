//
//  SsjjJMSDKRebindPhoneView.h
//  4399CoreSdk
//
//  Created by xianxian on 16/8/30.
...
typedef void(^SsjjRebindPhoneBlock)(NSString *phone,NSString *captcha);
typedef void(^SsjjGetsmsBlock)(NSString *phone);

@interface SsjjJMSDKRebindPhoneView : SsjjJMContentView
...
@property (nonatomic,copy) SsjjRebindPhoneBlock rebindBlock;
